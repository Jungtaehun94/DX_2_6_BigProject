...
with expander:
    st.markdown("""<div style="frameBorder=0; overflow: hidden; margin: 15px auto; max-width: 1600px; padding:200px;">
        <iframe scrolling="no" src=https://nfds.go.kr/dashboard/quicklook.do style="border: 0px none; margin-left: 0px; height: 1380px; margin-top: -1200px; width: 1200px;">
        </iframe>
