...
add_logo()
gu_list = ['마포소방서','관악소방서','동작소방서','양천소방서','강서소방서','노원소방서','강동소방서','영등포소방서','송파소방서','성북소방서','종로소방서','서초소방서'
...
if add_selectbox:
    ...
    with col2:
        ...
        base = alt.Chart(source).encode(theta=alt.Theta("value:Q", stack=True), color=alt.Color("category:N", legend=None, scale=alt.Scale(scheme='goldred'))).properties(height=385)
