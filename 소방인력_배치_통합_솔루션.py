...
#             break;
    ...
    with cols[0]:
        mapping_demo()
        st.markdown("""<div style="margin-top:-650px;z-index:999;position:relative;width: 300px;height:50px;background-color: rgba(0,0,0,.2);display: flex;align-items: center;">
