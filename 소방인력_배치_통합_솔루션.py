...
#             break;
    ...
    with cols[0]:
        mapping_demo()
        st.markdown("""<div style="margin-left:30px;margin-top:-650px;z-index:999;position:relative;width: 300px;height:50px;background-color: rgba(255,255,255,.5);display: flex;align-items: center;">
  <ul style="display:flex;flex-direction:row;width: 220px;align-items: center;padding-left:16px;">
