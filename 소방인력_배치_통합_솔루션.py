...
#             break;
    ...
    with cols[0]:
        st.markdown("""<ul style="display: flex; flex-direction: row; margin: 0px; padding: 0px;"><li style="align-items: center; cursor: pointer; display: flex; flex-direction: row; margin-left: 10px;"><span style="background: rgba(255, 99, 132, 0.5); border-color: rgb(255, 99, 132); border-width: 3px; display: inline-block; height: 20px; margin-right: 10px; width: 20px;"></span><p style="color: rgb(102, 102, 102); margin-top: -100px; padding: 0px;">Dataset: 1</p></li><li style="align-items: center; cursor: pointer; display: flex; flex-direction: row; margin-left: 10px;"><span style="background: rgba(54, 162, 235, 0.5); border-color: rgb(54, 162, 235); border-width: 3px; display: inline-block; height: 20px; margin-right: 10px; width: 20px;"></span><p style="color: rgb(102, 102, 102); margin: 0px; padding: 0px;">Dataset: 1</p></li></ul>""", unsafe_allow_html=True)
        mapping_demo()
if to_show == '실시간 출동 현황':
